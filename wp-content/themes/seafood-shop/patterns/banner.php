...
<h1 class="wp-block-heading banner-title has-heading-font-family" style="font-size:40px;font-style:normal;font-weight:600;line-height:1.6"><?php echo esc_html__( 'Cicipi Dimsum Terbaik, Dibuat dengan Sepenuh Hati', 'seafood-shop' ); ?></h1>
<!-- /wp:heading -->
...
<p class="banner-para has-text-1-color has-text-color has-link-color" style="margin-top:30px;margin-bottom:30px;padding-right:18rem;font-size:22px"><?php echo esc_html__( 'Dibuat segar setiap hari, dikukus hingga sempurna', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button btn-text"><a class="wp-block-button__link has-custom-font-size wp-element-button" href="#" style="border-radius:30px;padding-top:8px;padding-right:35px;padding-bottom:8px;padding-left:35px;font-size:15px;text-transform:capitalize"><?php echo esc_html__( 'Pesan Dimsum Hangat', 'seafood-shop' ); ?></a></div>
<!-- /wp:button -->
