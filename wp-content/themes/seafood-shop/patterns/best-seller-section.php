...
<h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-heading-font-family" style="font-size:22px;font-style:normal;font-weight:600;text-decoration:underline;text-transform:capitalize"><?php echo esc_html__( 'produk terlaris kami', 'seafood-shop' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-text-2-color has-text-color has-link-color has-body-font-family" style="margin-top:12px;font-size:23px;font-style:normal;font-weight:400;text-transform:capitalize"><?php echo esc_html__( 'Paling Disukai Pelanggan Kami', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h5 class="wp-block-heading product-title has-secondary-color has-text-color has-link-color has-heading-font-family" style="font-size:20px;font-style:normal;font-weight:600;text-transform:capitalize"><?php echo esc_html__( 'Har Gow (Shrimp Dumpling)', 'seafood-shop' ); ?></h5>
<!-- /wp:heading -->
...
<p class="product-desc has-text-2-color has-text-color has-link-color" style="font-size:14px"><?php echo esc_html__( 'Kulit tepung beras yang lembut diisi udang segar utuh — hidangan Dimsum klasik.', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="has-text-align-right product-price has-secondary-color has-text-color has-link-color" style="font-size:24px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Rp 28.000', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns product-head-box"><!-- wp:column {"width":"60%","className":"product-left"} -->
<div class="wp-block-column product-left" style="flex-basis:60%"><!-- wp:heading {"level":5,"className":"product-title","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"20px","textTransform":"capitalize","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary","fontFamily":"heading"} -->
<h5 class="wp-block-heading product-title has-secondary-color has-text-color has-link-color has-heading-font-family" style="font-size:20px;font-style:normal;font-weight:600;text-transform:capitalize"><?php echo esc_html__( 'Siu Mai (Pork & Shrimp Dumpling)', 'seafood-shop' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"product-desc","style":{"elements":{"link":{"color":{"text":"var:preset|color|text-2"}}},"typography":{"fontSize":"14px"}},"textColor":"text-2"} -->
<p class="product-desc has-text-2-color has-text-color has-link-color" style="font-size:14px"><?php echo esc_html__( 'Dimsum kukus terbuka berisi daging babi berbumbu dengan udang utuh di atasnya.', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"40%","className":"product-right"} -->
<div class="wp-block-column product-right" style="flex-basis:40%"><!-- wp:paragraph {"align":"right","className":"product-price","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"24px","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary"} -->
<p class="has-text-align-right product-price has-secondary-color has-text-color has-link-color" style="font-size:24px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Rp 30.000', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns product-head-box"><!-- wp:column {"width":"60%","className":"product-left"} -->
<div class="wp-block-column product-left" style="flex-basis:60%"><!-- wp:heading {"level":5,"className":"product-title","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"20px","textTransform":"capitalize","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary","fontFamily":"heading"} -->
<h5 class="wp-block-heading product-title has-secondary-color has-text-color has-link-color has-heading-font-family" style="font-size:20px;font-style:normal;font-weight:600;text-transform:capitalize"><?php echo esc_html__( 'Char Siu Bao (BBQ Pork Bun)', 'seafood-shop' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"product-desc","style":{"elements":{"link":{"color":{"text":"var:preset|color|text-2"}}},"typography":{"fontSize":"14px"}},"textColor":"text-2"} -->
<p class="product-desc has-text-2-color has-text-color has-link-color" style="font-size:14px"><?php echo esc_html__( 'Roti panggang lembut berisi daging babi BBQ manis gurih, berwarna keemasan di atasnya.', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"40%","className":"product-right"} -->
<div class="wp-block-column product-right" style="flex-basis:40%"><!-- wp:paragraph {"align":"right","className":"product-price","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"24px","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary"} -->
<p class="has-text-align-right product-price has-secondary-color has-text-color has-link-color" style="font-size:24px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Rp 25.000', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns product-head-box"><!-- wp:column {"width":"60%","className":"product-left"} -->
<div class="wp-block-column product-left" style="flex-basis:60%"><!-- wp:heading {"level":5,"className":"product-title","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"20px","textTransform":"capitalize","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary","fontFamily":"heading"} -->
<h5 class="wp-block-heading product-title has-secondary-color has-text-color has-link-color has-heading-font-family" style="font-size:20px;font-style:normal;font-weight:600;text-transform:capitalize"><?php echo esc_html__( 'Lo Mai Gai (Glutinous Rice in Lotus Leaf)', 'seafood-shop' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"product-desc","style":{"elements":{"link":{"color":{"text":"var:preset|color|text-2"}}},"typography":{"fontSize":"14px"}},"textColor":"text-2"} -->
<p class="product-desc has-text-2-color has-text-color has-link-color" style="font-size:14px"><?php echo esc_html__( 'Nasi ketan harum dengan ayam dan jamur, dikukus dalam daun teratai.', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"40%","className":"product-right"} -->
<div class="wp-block-column product-right" style="flex-basis:40%"><!-- wp:paragraph {"align":"right","className":"product-price","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"24px","fontStyle":"normal","fontWeight":"600"}},"textColor":"secondary"} -->
<p class="has-text-align-right product-price has-secondary-color has-text-color has-link-color" style="font-size:24px;font-style:normal;font-weight:600"><?php echo esc_html__( 'Rp 35.000', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
