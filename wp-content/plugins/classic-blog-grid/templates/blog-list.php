...
<div class="row clbgd-blog-list-item">
    <?php 
        if ($clbgd_enable_featured_image !== 'disable' && has_post_thumbnail()) : ?>
    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="clbgd-blog-post-image align-self-center">
            ...
            ?>
            <div class="clbgd-blog-list-img-outer <?php echo esc_attr($clbgd_image_aspect_class); ?>">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6  ">
            <div class=" clbgd-blog-post-title-outer-box align-self-center">
                ...
                <div class="clbgd-blog-category-title">
                    ...
                    <p class="clbgd-blog-post-category clbgd-blog-post-meta-font clbgd-blog-post-meta-font a">
                ...
                <div class="clbgd-list-admin-comment-box">
                    ...
                    <p class="clbgd-blog-post-comments align-self-center clbgd-blog-post-meta-font">
