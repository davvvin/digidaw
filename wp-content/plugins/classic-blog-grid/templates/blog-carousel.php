            ...
            <div class="swiper-slide">
                <div class="clbgd-carousel-item">
                    <?php if ($clbgd_enable_featured_image !== 'disable' && has_post_thumbnail()) : ?>
                        ...
                        ?>
                    <div class="carousel-image <?php echo esc_attr($clbgd_image_aspect_class); ?>">
                    ...
                    <div class="carousel-content">
                        ...
                        <a href="<?php the_permalink(); ?>" class="carousel-button clbgd-blog-post-content2 clbgd-button"><?php echo esc_html($clbgd_custom_read_more_text); ?></a>
                        <?php endif; ?>   
                    </div>
