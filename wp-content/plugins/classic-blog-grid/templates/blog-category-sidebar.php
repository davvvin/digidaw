...
$clbgd_selected_category = isset($_GET['category']) ? sanitize_text_field(wp_unslash($_GET['category'])) : ($clbgd_categories ? $clbgd_categories[0]->term_id : '');
        ...
        <div class="clbgd-sidebar"> 
            <ul>
                <?php foreach ($clbgd_categories as $clbgd_category) : 
                    $clbgd_class = ($clbgd_category->term_id == $clbgd_selected_category) ? 'class="selected"' : '';
                ?>
                    <li>
                        <a href="<?php echo esc_url(add_query_arg('category', $clbgd_category->term_id, get_permalink())); ?>" 
                            <?php echo esc_attr( $clbgd_class ); ?>>
            ...
            <?php while ($clbgd_query->have_posts()) : $clbgd_query->the_post(); ?>
                <div class="clbgd-post-item">
                    ...
                    <div class="clbgd-post-details">
                        <h3 class="clbgd-blog-post-tittle-font"><a class="clbgd-blog-post-tittle-font" href="<?php the_permalink(); ?>"><?php echo $clbgd_title_length ? esc_html(wp_trim_words(get_the_title(), $clbgd_title_length)) : esc_html(get_the_title()); ?></a></h3>
