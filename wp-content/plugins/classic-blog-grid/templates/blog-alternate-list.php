...
if ($clbgd_query->have_posts()):
    ...
    $clbgd_counter = 0; // To alternate content on odd/even posts
    while ($clbgd_query->have_posts()):
        $clbgd_query->the_post(); ?>

        <div class="row clbgd-alternate-item <?php echo ($clbgd_counter % 2 == 0) ? 'left-image' : 'right-image'; ?>">
            <div class=" clbgd-alternate-item-inner">
                <?php if ($clbgd_enable_featured_image !== 'disable' && has_post_thumbnail()): ?>
                    ...
                    ?>
                    <div class="col-lg-5 col-md-5 clbgd-alternate-image <?php echo esc_attr($clbgd_image_aspect_class); ?>">
                ...
                <div class="col-lg-6 col-md-6 clbgd-alternate-content">
                    ...
                    <div class="clbgd-alternate-excerpt clbgd-blog-post-excerpt-font">
                        <?php if ($clbgd_show_excerpt): ?>
                            <p><?php echo esc_html(wp_trim_words(get_the_excerpt(), $clbgd_excerpt_length, '...')); ?></p>
                        <?php endif; ?>
                    </div>

                    <div class="clbgd-alternate-admin-info">
                        <?php if ($clbgd_show_date): ?>
                            <p class="clbgd-alternate-date clbgd-blog-post-meta-font">
                                <?php echo esc_html(get_the_date('F j, Y')); ?></p>
                        <?php endif; ?>

                        <?php if ($clbgd_show_author): ?>
                            <p class="clbgd-alternate-author clbgd-blog-post-meta-font">
                                <?php echo esc_html__('By', 'classic-blog-grid') . ' ' . esc_html(get_the_author()); ?></p>
                        <?php endif; ?>

                        <?php if ($clbgd_show_comments): ?>
                            <p class="clbgd-alternate-comments clbgd-blog-post-meta-font">
