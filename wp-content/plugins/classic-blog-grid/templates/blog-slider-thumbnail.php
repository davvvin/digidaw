...
$clbgd_blog_posts = new WP_Query($clbgd_args);
if ($clbgd_blog_posts->have_posts()) : ?>
<!-- Main Swiper (Large Slider) -->
<div class="swiper-container main-slider">
    <div class="swiper-wrapper">
        <?php while ($clbgd_blog_posts->have_posts()) : $clbgd_blog_posts->the_post(); ?>
        <div class="swiper-slide">
            <div class="blog-slide">
                ...
                <?php if (has_post_thumbnail()) : ?>
                    ...
                    ?>
                <img src="<?php the_post_thumbnail_url('large'); ?>" alt="<?php echo esc_attr($clbgd_title_length ? wp_trim_words(get_the_title(), $clbgd_title_length) : get_the_title()); ?>"
                    class="main-slide-image <?php echo esc_attr($clbgd_image_aspect_class); ?>">
                <?php else : ?>
                ...
                <div class="clbgd-slider-content">
                    ...
                    <div class="clbgd-slider-meta-content">
                        ...
                        <p class="clbgd-slide-date clbgd-blog-post-meta-font">
                ...
                <!-- Navigation -->
                <div class="swipper-buttons-group">
...
<div class="swiper-container thumbnail-slider">
    <div class="swiper-wrapper">
        <?php
            $clbgd_blog_posts->rewind_posts(); // Reset loop
            while ($clbgd_blog_posts->have_posts()) : $clbgd_blog_posts->the_post();
            ?>
        <div class="swiper-slide">
            <?php if (has_post_thumbnail()) : ?>
            <img src="<?php the_post_thumbnail_url('thumbnail'); ?>" alt="<?php echo esc_attr($clbgd_title_length ? wp_trim_words(get_the_title(), $clbgd_title_length) : get_the_title()); ?>"
