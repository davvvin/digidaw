...
<p class="has-secondary-color has-text-color has-link-color" style="font-size:14px"><a href="tel:+1234567890" data-type="tel" data-id="tel:+1234567890"><i class="fa-solid fa-phone"></i><?php echo esc_html__( '+1234567890', 'seafood-shop' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontSize":"14px"}},"textColor":"secondary"} -->
<p class="has-secondary-color has-text-color has-link-color" style="font-size:14px"><a href="mailto:freshnetcatch@example.com"><i class="fa-regular fa-envelope"></i><?php echo esc_html__( 'freshnetcatch@example.com', 'seafood-shop' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-text-align-right has-secondary-color has-text-color has-link-color" style="font-size:14px;text-transform:capitalize"><i class="fa-solid fa-bullhorn"></i><?php echo esc_html__( 'Order Before 4 PM for Same-Day Dispatch!', 'seafood-shop' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-column is-vertically-aligned-center header-btm-left" style="flex-basis:40%"><!-- wp:navigation {"textColor":"text-1","icon":"menu","overlayBackgroundColor":"primary","metadata":{"ignoredHookedBlocks":["woocommerce/customer-account","woocommerce/mini-cart"]},"style":{"spacing":{"blockGap":"25px"},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"15px","textTransform":"capitalize"}},"layout":{"type":"flex","justifyContent":"left"}} --><!-- wp:navigation-link {"label":"home","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Shop","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Seafood Journal","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Contact","url":"#","kind":"custom","isTopLevelLink":true} /-->

<!-- wp:navigation-link {"label":"Buy Now","opensInNewTab":true,"url":"https://www.theclassictemplates.com/products/seafood-wordpress-theme","kind":"custom","isTopLevelLink":true} /-->
